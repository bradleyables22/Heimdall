namespace Heimdall.Bootstrap
{
    ...
    {
        /// <summary>
        /// Provides constant string values for common CSS class names used to style card components.
        /// </summary>
        /// <remarks>These constants are typically used to assign Bootstrap card-related CSS classes to
        /// HTML elements in web applications. Using these constants helps avoid typos and ensures consistency when
        /// applying card styles.</remarks>
