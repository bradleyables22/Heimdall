...
namespace Heimdall.Server.Rendering
{
    ...
    /// payload handling, swap behavior, trigger resolution behavior, state emission, and server-sent
    /// event configuration.
    /// </remarks>
    public static class HeimdallHtml
    {
        /// <summary>
        /// Defines Heimdall HTML attribute names used for content events, payloads, trigger resolution,
        /// state, and SSE configuration.
        /// </summary>
        public static class Attrs
        {
            ...
            /// <summary>
            /// The attribute that prevents Heimdall from resolving triggers past an element boundary
            /// for one or more trigger types.
            /// </summary>
            public const string Ignore = "heimdall-ignore";

            /// <summary>
            /// The attribute that controls how Heimdall matches an actionable element when a trigger fires.
            /// </summary>
        ...
        /// <summary>
        /// Defines how Heimdall should match an actionable element when a trigger fires.
        /// </summary>
        public enum Scope
        {
            /// <summary>
            /// Resolves the nearest eligible ancestor that declares the trigger attribute.
            /// </summary>
            Closest,

            /// <summary>
            /// Only resolves the element when it is the direct event target.
            /// </summary>
            Self
        }
        ...
        /// <summary>
        /// Defines Heimdall trigger names that can be used in ignore directives.
        /// </summary>
        public static class IgnoreTriggers
        {
            /// <summary>
            /// Ignores all Heimdall trigger resolution past the element boundary.
            /// </summary>
            public const string All = "*";

            /// <summary>
            /// Ignores click trigger resolution past the element boundary.
            /// </summary>
            public const string Click = "click";

            /// <summary>
            /// Ignores change trigger resolution past the element boundary.
            /// </summary>
            public const string Change = "change";

            /// <summary>
            /// Ignores input trigger resolution past the element boundary.
            /// </summary>
            public const string Input = "input";

            /// <summary>
            /// Ignores submit trigger resolution past the element boundary.
            /// </summary>
            public const string Submit = "submit";

            /// <summary>
            /// Ignores keydown trigger resolution past the element boundary.
            /// </summary>
            public const string KeyDown = "keydown";

            /// <summary>
            /// Ignores blur trigger resolution past the element boundary.
            /// </summary>
            public const string Blur = "blur";

            /// <summary>
            /// Ignores hover trigger resolution past the element boundary.
            /// </summary>
            public const string Hover = "hover";

            /// <summary>
            /// Ignores visible trigger resolution past the element boundary.
            /// </summary>
            public const string Visible = "visible";

            /// <summary>
            /// Ignores scroll trigger resolution past the element boundary.
            /// </summary>
            public const string Scroll = "scroll";

            /// <summary>
            /// Ignores load trigger resolution past the element boundary.
            /// </summary>
        ...
        /// <summary>
        /// Prevents Heimdall from resolving triggers past this element for the specified trigger types.
        /// </summary>
        /// <param name="triggers">
        /// One or more trigger names, such as <c>click</c>, <c>input</c>, or <c>*</c>.
        /// </param>
        /// <returns>
        /// An HTML attribute representing the ignore directive, or <see cref="Html.HtmlAttr.Empty" />
        /// when no trigger names are provided.
        /// </returns>
        public static Html.HtmlAttr Ignore(params string[] triggers)
        {
            ...
            return Html.Attr(Attrs.Ignore, string.Join(" ", tokens));
        }

        /// <summary>
        /// Prevents Heimdall from resolving triggers past this element for the specified trigger types.
        /// </summary>
        /// <param name="triggers">The triggers to ignore.</param>
        /// <returns>
        /// An HTML attribute representing the ignore directive, or <see cref="Html.HtmlAttr.Empty" />
        /// when no triggers are provided.
        /// </returns>
        ...
        /// <summary>
        /// Controls how Heimdall matches an actionable element when the trigger fires.
        /// </summary>
        /// <param name="scope">The trigger matching scope to apply.</param>
        /// <returns>An HTML attribute representing the scope behavior.</returns>
        public static Html.HtmlAttr ScopeMode(Scope scope)
            => Html.Attr(Attrs.Scope, ScopeToString(scope));
        ...
        /// <returns>An HTML content instance representing the redirect directive.</returns>
        ...
        private static string ScopeToString(Scope scope) => scope switch
        {
            Scope.Closest => "closest",
            Scope.Self => "self",
            _ => "closest"
        };
